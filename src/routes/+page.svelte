...
<main class="intro">
	<div class="introduction">
			<h2 class="hero glitch layers" data-text="KaiYu"><span>于凯帆</span></h2>
		<br>
		<br>
		<br>
		<span id="text" class="text-3xl font-bold text-blue-900">Software Engineer / Information Security</span>
		<br>
		<br>
		<span id="text" class="text-3xl text-gray-400">Computer Science student at UC Irvine.</span>
		<br>
		<br>
